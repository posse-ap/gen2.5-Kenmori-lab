...
// 問題の複製
for (let i = 0; i < 10; i++) {
    let choices = ['<li class="choice" id="true-choice' + [i] + '">' + choice[i][0] + '</li>', '<li class="choice" id="wrong-choice' + [i] + 1 + '">' + choice[i][1] + '</li>', '<li class="choice" id="wrong-choice' + [i] + 2 + '">' + choice[i][2] + '</li>']
